...
<div class="photo-grid">
  {% assign all_files = site.static_files | where_exp:"file","file.path contains '/assets/photos/2025/June/'" %}
  {% assign photos = "" | split: "" %}
...
body {
  ...
  margin: 0;
  min-height: 100vh;
  background-image: url('/assets/june.jpg');
